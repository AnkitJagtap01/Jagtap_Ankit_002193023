...
public class PersonScreen extends javax.swing.JPanel {
    ...
    public boolean validateData() {
        ...
        if (txtFullName.getText().equals("") || txtState.getText().equals("") || txtCity.getText().equals("") || txtAdd.getText().equals("") || txtComm.getText().equals("")
                || txtAptNo.getText().equals("") || txtPersonId.getText().equals("") || txtZip.getText().equals("") || dob.equals("")) {
            ...
            if (txtAdd.getText().length() < 5 || !txtAdd.getText().matches("[a-z A-Z ]+")) {
                JOptionPane.showMessageDialog(this, "Please enter a valid address.");
                return false;
            }

            if (txtComm.getText().length() < 2 || !txtComm.getText().matches("[a-z A-Z ]+")) {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (validateData()) {
            ...
            House h = new House(txtAdd.getText(), txtAptNo.getText(), txtState.getText(), new Community(txtComm.getText()), new City(), Integer.valueOf(txtZip.getText()));
